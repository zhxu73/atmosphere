...
router.register(
    r'access_tokens', views.AccessTokenViewSet, base_name='access_token'
)
...
router.register(
    r'email_feedback', views.FeedbackEmailViewSet, base_name='email-feedback'
)
router.register(
    r'email_instance_report',
    views.InstanceSupportEmailViewSet,
    base_name='instance-email-support'
)
router.register(
    r'email_volume_report',
    views.VolumeSupportEmailViewSet,
    base_name='volume-email-support'
)
router.register(
    r'email_request_resources',
    views.ResourceEmailViewSet,
    base_name='email-request-resources'
)
router.register(
    r'emulate_token', views.TokenEmulateViewSet, base_name='emulate-token'
)
router.register(
    r'emulate_session',
    views.SessionEmulateViewSet,
    base_name='emulate-session'
)
router.register(r'help_links', views.HelpLinkViewSet)
router.register(r'identities', views.IdentityViewSet)
router.register(
    r'identity_memberships',
    views.IdentityMembershipViewSet,
    base_name='identitymembership'
)
router.register(r'images', views.ImageViewSet, base_name='application')
router.register(
    r'image_metrics', views.ImageMetricViewSet, base_name='applicationmetric'
)
router.register(r'image_bookmarks', views.ImageBookmarkViewSet)
router.register(r'image_tags', views.ImageTagViewSet)
router.register(
    r'image_access_lists',
    views.ImageAccessListViewSet,
    base_name='applicationaccesslist'
)
router.register(
    r'image_versions', views.ImageVersionViewSet, base_name='imageversion'
)
router.register(
...
router.register(
    r'project_links',
    views.ProjectExternalLinkViewSet,
    base_name='projectlinks'
)
router.register(r'project_images', views.ProjectApplicationViewSet)
router.register(
    r'project_instances',
    views.ProjectInstanceViewSet,
    base_name='projectinstances'
)
router.register(
    r'project_volumes', views.ProjectVolumeViewSet, base_name='projectvolumes'
)
...
router.register(
    r'provider_types', views.ProviderTypeViewSet, base_name='providertype'
)
router.register(r'quotas', views.QuotaViewSet)
router.register(
    r'renewal_strategy',
    views.RenewalStrategyViewSet,
    base_name='renewalstrategy'
)
...
router.register(
    r'token_update', views.TokenUpdateViewSet, base_name='token_update'
)
router.register(r'tokens', views.TokenViewSet, base_name='token')
router.register(r'users', views.UserViewSet)
router.register(
    r'user_allocation_sources',
    views.UserAllocationSourceViewSet,
    base_name='user-allocation-source'
)
...
router.register(
    r'deploy_version',
    base_views.DeployVersionViewSet,
...
urlpatterns = [
    ...
    url(
        r'^web_tokens/(?P<pk>[a-zA-Z0-9-]{36})',
